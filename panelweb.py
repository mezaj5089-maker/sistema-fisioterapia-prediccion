...
# ---------------------------------------------------------
# ESTILOS CSS CON CONTRASTE ADAPTATIVO REVISADO
# ---------------------------------------------------------
st.markdown("""
    <style>
    ...
    /* Encabezados y títulos principales en blanco */
    ...
    /* Pestañas (Tabs): Texto blanco visible + HOVER interactivo */
    ...
    /* 1. Calendario de Fecha (Date Input Popover / Calendar) */
    div[data-baseweb="calendar"] *, 
    div[data-baseweb="popover"] * {
        color: #0f172a !important; /* Texto oscuro para fondo claro */
    }
    ...
    /* 2. Selectbox (Listas Desplegables) */
